...
def process_results(CV, explainers, areas):
    ...
    name_dict = {'fit': 'FIT', 'deep_lift': 'DL', 'afo': 'AFO', 'fo': 'FO', 'retain': 'RT', 'integrated_gradient': 'IG',
                 'gradient_shap': 'GS',  'lime': 'LIME', 'dynamask': 'MASK'}
    ...
    for cv in range(CV):
        ...
        model = StateClassifier(feature_size=N_features, n_state=2, hidden_size=200,
                                rnn='GRU', device=device, return_all=True)
